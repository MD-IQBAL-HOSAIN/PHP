...
$title = $_GET['name']??"Nothing";

$mylinks = 'iqus-product.php?id='.($_GET['id']??"1")."&name=".$title;

$fulllink = "<li><a href='{$mylinks}'>{$title}</a></li>";

$url = 'https://dummyjson.com/products/'.$_GET['id']??"1";

if (! in_array($fulllink,$_SESSION['urls'])) 
    $_SESSION['urls'][] = $fulllink;
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2" id="ptitle">Active Wear</h1>
                            <p class="h3 py-2" id="pprice">$25.00</p>
                            <p class="py-2">
    ...
    <hr>
    <div>
        <h3>Recent visited product</h3>
        <?php
        if (count($_SESSION['urls'])) {
    ...
    <script>
        ...
        function show(d) {
            console.log(d);
            console.log(d);
            document.getElementById("ptitle").innerHTML=d.title;
            document.getElementById("pprice").innerHTML=d.price;
            document.getElementById("product-detail").src=d.thumbnail;
        }
        function load() {
            fetch('<?= $url ?>')
                .then(res => res.json())
